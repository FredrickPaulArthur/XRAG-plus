# V3 is better for QA Reranking

# This model takes (query, passage) pairs and outputs relevance scores.
...
cohere_key = os.getenv("COHERE_KEY")   # Get your API key from www.cohere.com
